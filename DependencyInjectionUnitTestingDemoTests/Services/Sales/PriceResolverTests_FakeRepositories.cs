...
namespace DependencyInjectionUnitTestingDemo.Tests.Services.Sales
{
	[TestClass]
	public class PriceResolverTests_FakeRepositories
	{
		...
		{
			public decimal? GetDiscountForCustomerAndProductGroup(Customer customer, ProductGroup productGroup) => null;
		}
		...
		{
			public decimal? GetCustomerPrice(Customer customer, Product product) => null;
		}
